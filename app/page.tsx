...
export default function Home() {
    ...
    return (
        ...
        <div>
            <Navigation user={''}/>
            <main
                className="w-full max-w-screen-2xl  mx-auto pt-10 grid grid-cols-1 gap-4 items-center justify-center mt-0 lg:mt-[10em] xl:mt-0 transition-[grid-template-columns] lg:grid-cols-[160px_1fr] lg:gap-8 px-2"
            >
